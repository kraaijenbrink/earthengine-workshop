...
**You can always search for help on functions in the docs tab on the top left panel, and that there is a concise [online user guide](https://developers.google.com/earth-engine/) with clear examples, accessible via the help dropdown menu in the top right corner.**
